...
/** \mainpage RoboComp::imperium
 *
 * \section intro_sec Introduction
 *
 * The imperium component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/imperium --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class imperium : public RoboComp::Application
{
public:
	imperium (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::imperium::run(int argc, char* argv[])
{
